...
* **How It Works**:
  ...
  4. Only that version's code is fully initialized
  5. The `wp_feature_api_init` action is fired when initialization is complete
  6. All plugins register their features using this hook

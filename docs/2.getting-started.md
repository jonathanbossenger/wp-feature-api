...
Currently, the Feature API is implemented as a WordPress plugin. While it is not yet a core component, it is designed to be potentially included in a future WordPress core release.

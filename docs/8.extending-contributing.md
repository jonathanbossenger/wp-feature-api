...
If the Features API evolves into a core feature or canonical plugin, contribution guidelines would be established through the standard WordPress contribution process (Trac, GitHub).
